...
class WP_Event_Manager
{
    ...
    public function frontend_scripts()
    {
        ...
        wp_localize_script('wp-event-manager-content-event-listing', 'event_manager_content_event_listing', array(
            'i18n_datepicker_format' => WP_Event_Manager_Date_Time::get_datepicker_format(),
            'i18n_initialText' => __('Interval de timp', 'wp-event-manager'),
            ...
            'i18n_dayNames' => $this->strip_array_indices($wp_locale->weekday),
            'i18n_dayNamesMin' => $this->strip_array_indices($wp_locale->weekday_abbrev),
            'i18n_today' => __('Azi', 'wp-event-manager'),
            'i18n_tomorrow' => __('Maine', 'wp-event-manager'), // replace 'Main' with 'Maine'
            'i18n_thisWeek' => __('Saptamana aceasta', 'wp-event-manager'),
            'i18n_nextWeek' => __('Saptamana viitoare', 'wp-event-manager'),
            'i18n_thisMonth' => __('Luna aceasta', 'wp-event-manager'),
            'i18n_nextMonth' => __('Luna viitoare', 'wp-event-manager'),
            'i18n_thisYear' => __('Anul acesta', 'wp-event-manager'),
            'i18n_nextYear' => __('Anul viitor', 'wp-event-manager')
        ));
        // Ajax filters js
