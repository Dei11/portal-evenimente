...
<form class="wpem-main wpem-form-wrapper wpem-event-filter-wrapper event_filters" id="event_filters">
	...
	<div id="event_manager_event_filters">
		<?php do_action('event_manager_event_filters_start', $atts); ?>
		<div id="search_events search-form-container">
...
<script>
	...
	var content = document.getElementById("event_manager_event_filters");
	toggle.addEventListener("click", (e) => {
		...
		if (currentDisplay == "none") {
			...
			toggle.style.backgroundColor = "#d3ad3b";
